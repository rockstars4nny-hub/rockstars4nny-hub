...
**BLE Hound** — Bluetooth LE security research stack for authorized testing: passive capture, live packet dissection, active GATT interaction, automated findings, repeatable probe scripting, optional decrypt when keys are available, and standard export formats with a live operator UI.
